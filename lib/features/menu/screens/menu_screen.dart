...
import 'package:klixstore/common/widgets/language_select_widget.dart';
...
import 'package:klixstore/features/language/widgets/language_select_button_widget.dart';
import 'package:klixstore/features/menu/widgets/menu_web_widget.dart';
import 'package:klixstore/features/menu/widgets/portion_widget.dart';
                              ...
                              : Column(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: rubikBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Colors.white),
                                    ),
                                    if (isLoggedIn)
                                      Text(
                    ...
                    child: Column(children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            PortionWidget(
                                imageIcon: Images.order, title: getTranslated('my_orders', context), route: Routes.getOrderListScreen()),
                            PortionWidget(
                                imageIcon: Images.address, title: getTranslated('my_address', context), route: Routes.getAddressRoute()),
                            PortionWidget(
                                imageIcon: Images.couponMenuIcon, title: getTranslated('coupon', context), route: Routes.getCouponRoute()),
                            InkWell(
                              onTap: () {
                                    ...
                                    builder: (ctx) => Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                              Text(getTranslated('choose_the_language', context),
                              ...
                              child:
                                  PortionWidget(imageIcon: Images.language, title: getTranslated('language', context), hideDivider: true),
                            ),
                          ]),
                        )
                      ]),
                      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            PortionWidget(
                                imageIcon: Images.message, title: getTranslated('live_chat', context), route: Routes.getChatRoute()),
                            PortionWidget(
                                imageIcon: Images.helpSupport,
                                title: getTranslated('help_and_support', context),
                                route: Routes.getSupportRoute()),
                            PortionWidget(
                                imageIcon: Images.aboutUs, title: getTranslated('about_us', context), route: Routes.getAboutUsRoute()),
                            PortionWidget(
                        ...
                        Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            InkWell(
                              ...
                              child: PortionWidget(
                                  imageIcon: Images.userDeleteIcon, title: getTranslated('delete_account', context), hideDivider: true),
                            ),
                          ]),
                        ),
                      InkWell(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Container(
                              ...
                              child: Icon(Icons.power_settings_new_sharp,
                                  size: Dimensions.paddingSizeDefault, color: Theme.of(context).cardColor),
                            ),
